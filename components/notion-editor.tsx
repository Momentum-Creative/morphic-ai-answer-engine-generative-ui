    ...
    return (
      <div className="flex flex-col items-center justify-center py-8 text-center">
        ...
        <h3 className="text-base font-medium mb-2">
          Click a concept node above to start
        </h3>
        <p className="text-xs text-muted-foreground max-w-sm">
          Select Brand, Tone, Story, or any other node to begin developing your
          video concept with AI assistance.
        </p>
      </div>
    )
  }
...
• "Think Apple meets Patagonia - clean design with environmental values"`
      ...
      {nodeContent[selectedNodeId] &&
        nodeContent[selectedNodeId] !== localContent && (
